...
```text
使用 $project-knowledge-base 为 Find X10e 建立项目知识库。
```

基于知识库提问时，可以这样说：

```text
使用 $project-knowledge-base 基于 Find X10e 的项目知识库，总结这个项目的核心卖点。
```

更新资料时，可以这样说：

```text
使用 $project-knowledge-base 我新增了一份竞品分析文件，请帮我判断放在哪里，并更新项目索引。
```
